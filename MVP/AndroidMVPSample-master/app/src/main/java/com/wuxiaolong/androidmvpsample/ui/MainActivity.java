...
public class MainActivity extends MvpActivity<MainPresenter> implements MainView {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button3:
                //请求接口
                Log.v("test","button3");
                apiStores.loadDataByRetrofit("101190201");
                break;
        }
    }
    ...
    private void loadDataByRetrofitRxjava() {
        showProgressDialog();    //顯示進度畫面
        addSubscription(
                apiStores.loadDataByRetrofitRxjava("101220602"),    //觀察物件
                new ApiCallback<MainModel>() {                      //訂閱者
